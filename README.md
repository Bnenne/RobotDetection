...
# Use
To use the project you can download the release, unzip the file, then run the executable. If you would like to use a different video than the one provided, just name "test_track.mp4" and place it in the directory with the executable.
